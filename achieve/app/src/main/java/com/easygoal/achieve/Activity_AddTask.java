...
public class Activity_AddTask extends BaseActivity {
    ...
    public void dobusiness() {
        ...
        final ListView lv_quickinput_model1=(ListView)findViewById(R.id.lv_quickinput);
        final Spinner spin_deadline_model1 = (Spinner)findViewById(R.id.model_task_item15_deadline_spin);
        final EditText et_checklist_model1=(EditText)findViewById(R.id.model1_checklist_et);
        final TextView tv_taskdeadline_model1=(TextView)findViewById(R.id.model1_task_item15_deadline_tv);
        final TextView et_taskname_model1=(TextView)findViewById(R.id.model1_taskname_et);
        final Button model1_taskadd_btn=(Button)findViewById(R.id.model1_taskadd_btn);
        final CheckBox model1_reminder_cb=(CheckBox)findViewById(R.id.model1_reminder_cb);
        final Button model1_task_confirm_bt=(Button)findViewById(R.id.model1_task_confirm_bt);
        final Button model1_task_cancel_bt=(Button)findViewById(R.id.model1_task_cancel_bt);
        final TextView tv_taskcreatedtime_model1=(TextView)findViewById(R.id.model1_task_item2_createdtime_tv);
        final TextView tv2_taskcreatedtime=(TextView)findViewById(R.id.task_item2_createdtime_tv);
        //final TextView tv_newtaskheader=(TextView)findViewById(R.id.tv_newtaskheader);
        final TextView tv_maxvalue=(TextView)findViewById(R.id.tv_maxvalue);
        final EditText et1_taskname=(EditText)findViewById(R.id.task_item1_name_et);
        final EditText et2_taskcreatedtime=(EditText)findViewById(R.id.task_item2_createdtime_et);
        final EditText et3_taskdescription=(EditText)findViewById(R.id.task_item3_description_et);
        final EditText et4_taskimportance=(EditText)findViewById(R.id.task_item4_importance_et);
        final EditText et5_taskurgency=(EditText)findViewById(R.id.task_item5_urgency_et);
        final EditText et6_taskassess=(EditText)findViewById(R.id.task_item6_assess_et);
        final EditText et7_taskpriority=(EditText)findViewById(R.id.task_item7_priority_et);
        final EditText et8_taskpassion=(EditText)findViewById(R.id.task_item8_passion_et);
        final EditText et9_taskdifficulty=(EditText)findViewById(R.id.task_item9_difficulty_et);
        final EditText et10_taskduration=(EditText)findViewById(R.id.task_item10_duration_et);
        final EditText et11_taskachieved=(EditText)findViewById(R.id.task_item11_achieved_et);
        final EditText et12_taskenjoyment=(EditText)findViewById(R.id.task_item12_enjoyment_et);
        final EditText et13_taskexperience=(EditText)findViewById(R.id.task_item13_experience_et);
        final EditText et14_taskstartedtime=(EditText)findViewById(R.id.task_item14_startedtime_et);
        final EditText et15_taskdeadline=(EditText)findViewById(R.id.task_item15_deadline_et);
        final EditText et16_taskprogress=(EditText)findViewById(R.id.task_item16_progress_et);
        final CheckBox cb17_taskreminder=(CheckBox)findViewById(R.id.task_item17_reminder_cb);
        final EditText et18_taskstatus=(EditText)findViewById(R.id.task_item18_status_et);
        final EditText et19_taskfinished=(EditText)findViewById(R.id.task_item19_finished_et);
        final EditText et20_taskdelayed=(EditText)findViewById(R.id.task_item20_delayed_et);
        final TextView tv21_taskmaxperiod=(TextView)findViewById(R.id.tv_maxAvailDays);
        final EditText et_model1_duration_et=(EditText)findViewById(R.id.model1_duration_et);
        final Spinner spin_model1_timeunit=(Spinner)findViewById(R.id.model1_timeunit_spin);
       ...
       final TabHost tabhost=(TabHost)findViewById(android.R.id.tabhost);
        ...
        mArrayAdapter adap_spin_deadline = new mArrayAdapter(getApplication(), R.layout.spinner_timechoice, list_deadline);
        ...
        final Spinner spin4_taskimportance = (Spinner)findViewById(R.id.task_item4_importance_spin);
        ...
        // list_imp.add(new InputValueSet(4,"至关重要"));
        mArrayAdapter adap_spin4_taskimportance = new mArrayAdapter(getApplication(), R.layout.myspinner_item, list_imp);
        // adap_spin4_taskimportance.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spin4_taskimportance.setAdapter(adap_spin4_taskimportance);

        final Spinner spin5_taskurgency = (Spinner)findViewById(R.id.task_item5_urgency_spin);
        ...
        mArrayAdapter adap_spin5_taskurgency = new mArrayAdapter(getApplication(), R.layout.myspinner_item, list_urg);
        ...
        final Spinner spin8_taskpassion = (Spinner)findViewById(R.id.task_item8_passion_spin);
        ...
        mArrayAdapter adap_spin8_taskpassion = new mArrayAdapter(getApplication(), R.layout.myspinner_item, list_passion);
        ...
        final Spinner spin9_taskdifficulty = (Spinner)findViewById(R.id.task_item9_difficulty_spin);
        ...
        mArrayAdapter adap_spin9_taskdifficulty = new mArrayAdapter(getApplication(), R.layout.myspinner_item, list_difficulty);
        ...
        final Spinner spin_timeunit = (Spinner)findViewById(R.id.timeunit_spin);
        ...
        //   list_difficulty.add(new InputValueSet(4,"极其困难"));	
        mArrayAdapter adap_spin_timeUnit = new mArrayAdapter(getApplication(), R.layout.myspinner_item, list_timeUnit);
        // adap_spin9_taskdifficulty.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spin_timeunit.setAdapter(adap_spin_timeUnit);

        mArrayAdapter adap_spin_timeUnit_model1 = new mArrayAdapter(getApplication(), R.layout.myspinner_item, list_timeUnit);
        // adap_spin9_taskdifficulty.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spin_model1_timeunit.setAdapter(adap_spin_timeUnit_model1);


        Button btn_confirm=(Button)findViewById(R.id.task_confirm_bt);
        Button btn_cancel=(Button)findViewById(R.id.task_cancel_bt);
        Button btn_close = (Button) findViewById(R.id.task_close_bt);
        ...
        //  final SimpleCursorAdapter adapter = new SimpleCursorAdapter(getApplication(), R.layout.show_alltask, c, new String[] {TdDB.TASK_ID,TdDB.TASK_NAME,TdDB.TASK_IMPORTANCE},new int[]{R.id.task1_id_tv,R.id.task1_name_tv,R.id.task1_importance_tv}, 0);
        ...
        //final EditText usedTimeEachWeek_et=(EditText)findViewById(R.id.usedTimeEachWeek_et);

        spin_timeunit.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
        ...
        spin_deadline_model1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener(){
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                //Toast.makeText(getApplication(), "点击了"+selItem_deadline, Toast.LENGTH_SHORT).show();
        ...
        lvadapter_model1=new lvBaseAdapter_AddTaskModel1(getApplication(),TaskData.ls1);
        lv_quickinput_model1.setAdapter(lvadapter_model1);

        model1_taskadd_btn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                if (!TextUtils.isEmpty(et_checklist_model1.getText().toString())) {
                    ...
                    Toast.makeText(getApplication(),"内容为空" , Toast.LENGTH_SHORT).show();
                }
            }
        ...
        model1_task_confirm_bt.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                if (TextUtils.isEmpty(inputstr_taskname)) {
                    Toast.makeText(getApplication(),"任务名不能为空" , Toast.LENGTH_SHORT).show();
                }else{
                    ContentValues cv1 = new ContentValues();
                    double daygap=TimeData.DaySpace_YY(curTime,tv_taskdeadline_model1.getText().toString());
                    //Toast.makeText(getApplication(),"daygap"+daygap, Toast.LENGTH_SHORT).show();
                    if (daygap>=1){
                        dm1=daygap;
                        model1_durationunit=1;
                    ...
                    //Toast.makeText(getApplication(),"duration"+df_duration.format(dm1), Toast.LENGTH_SHORT).show();
                            ...
                            for(int i=0;i<TaskData.ls1.size();i++){
                                if (TaskData.ls1.get(i).getRECORD_VALIDITY().equals("true")){
                                    ...
                                    if (i!=(TaskData.ls1.size()-1))
                                        ...
                                        //Toast.makeText(getApplication(), ""+lastsubweight, Toast.LENGTH_SHORT).show();
                    ...
                    if (reminder_model1=="true"){
                        ...
                        TaskTool.setReminder(getApplication(),tv_taskdeadline_model1.getText().toString(),
                                "T"+taskid,
                    ...
                    Toast.makeText(getApplication(), "任务添加成功",Toast.LENGTH_SHORT).show();
        ...
        model1_task_cancel_bt.setOnClickListener(new View.OnClickListener(){
        ...
        et15_taskdeadline.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    //Toast.makeText(getApplication(), deadline+"\n"+date1, Toast.LENGTH_LONG).show(); 
        ...
        class EditChangedListener implements TextWatcher {
	       ...
	       /*
	        et15_taskdeadline.setOnClickListener(new OnClickListener() {
	            ...
	            public void onClick(View v) {
	                DatePickerDialog dialog = new DatePickerDialog(getApplication(), new DatePickerDialog.OnDateSetListener() {
	                    @Override
                    ...
                    if (TaskData.durationcheck==true){
                        ...
                        if (!TextUtils.isEmpty(endTime_YY)){
                            ...
                            if (temp_duration> maxDuration){
                                Toast.makeText(getApplication(), "超过MAX"+df_duration.format(maxDuration)+durationunit,Toast.LENGTH_SHORT).show();
                                et10_taskduration.setText("");
                            }
                        }else{
                            Toast.makeText(getApplication(), "请先输入最后期限",Toast.LENGTH_SHORT).show();
                        }
                    }
                }else{
                    Toast.makeText(getApplication(), "请输入数值",Toast.LENGTH_SHORT).show();
                }
            }
        ...
        btn_confirm.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (deadlineflag){
                    Toast.makeText(getApplication(),"最后期限不能为空" , Toast.LENGTH_SHORT).show();
                }

                if (durationflag){
                    Toast.makeText(getApplication(),"预计用时不能为空" , Toast.LENGTH_SHORT).show();
                }else{
                    if (TaskTool.isNumeric(inputstr_duration)){
                        ...
                        if (Double.parseDouble(inputstr_duration)>=0){
                            ...
                            Toast.makeText(getApplication(),"预计用时必须为≥0数字" , Toast.LENGTH_SHORT).show();
                        }
                ...
                if (totalflag) {
					...
					*/
                    ...
                    //Toast.makeText(getApplication(), insertstr_column, Toast.LENGTH_LONG);
                    String aaa = "  values (";
                    ...
                    //Toast.makeText(getApplication(), insertstr_value, Toast.LENGTH_LONG);
                    ...
                    //TaskData.db_TdDB.update(TaskData.TdDB.TABLE_NAME_TaskMain, cv, null, null);
					   ...
					   /*
					   new ConnMySQL(getApplication()).InsertGsonArrayRequestPost("TaskmainServlet",TaskData.TdDB.TABLE_NAME_TaskMain,lastRowId);
					   Toast.makeText(getApplication(), "已同步插入"+lastRowId,Toast.LENGTH_SHORT).show();
						 Log.d("insert by Mysql","done");
						*/

                    if (taskreminder=="true"){

                        TaskTool.setReminder(getApplication(),
                ...
                //Toast.makeText(getApplication(),"sequence"+float_sn_sequence, Toast.LENGTH_SHORT).show();
            }
