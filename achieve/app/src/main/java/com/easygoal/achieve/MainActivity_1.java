				...
				switch (menuItem.getItemId()) {
					case R.id.action_sharepic:
                        ...
                        */
						...
						String a=screenshot.shoot(MainActivity_1.this,saveFileName);
						Log.d("screenshot","shoot"+a);
						File file1=new File(FileUtils.getDiskCacheDirPath(getApplicationContext())+"Bitmap/"+saveFileName);
						Log.d("screenshot","file exist "+file1.exists());
						Uri u=Uri.fromFile(new File(FileUtils.getDiskCacheDirPath(getApplicationContext())+"Bitmap/"+saveFileName));
