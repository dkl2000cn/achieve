       ...
       /*
        ...
        if ((offX < -100)) {
                ...
                if ( itemLayout!=null) {
                    ...
                    //mScroller.startScroll((int)lastX,(int)lastY,offX,(int)lastY);
                    ...
                    animationSet.addListener(new Animator.AnimatorListener() {
                        ...
                        public void onAnimationEnd(Animator animation) {
                            if (selectedItem >= 0) {
                                itemLayout.setBackgroundResource(R.color.mTextColor2); itemLayout.setBackgroundResource(R.color.mTextColor2);
                                //itemLayout.scrollBy(-DisplayUtils.getScreenWidth(getContext()), 0);
                                //itemLayout.offsetLeftAndRight(500);
                                ObjectAnimator anim2 = ObjectAnimator.ofFloat(itemLayout, "translationX", 0, 0)
                                        .setDuration(0)
                                        ;
                                anim2.start();
