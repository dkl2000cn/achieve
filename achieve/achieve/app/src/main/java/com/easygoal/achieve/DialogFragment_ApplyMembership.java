...
public class DialogFragment_ApplyMembership extends DialogFragment {


	public DialogFragment_ApplyMembership() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View v=inflater.inflate(R.layout.leftmenu_applymembership, container);
	    ...
	    btn_confirm.setOnClickListener(new OnClickListener() {
	            ...
	            public void onClick(View arg0) {
	            	...
	            	emailIntent.setType("text/plain");
		     		...
		     		//设置对方邮件地址
		     		emailIntent.putExtra(Intent.EXTRA_EMAIL,new String[]{mailaddress.getText().toString()});
		     		//设置标题内容
		     		...
		     		startActivity(Intent.createChooser(emailIntent,"申请高级会员"));
