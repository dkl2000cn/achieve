...
public class ExportListToExcelById {  
    ...
    public ExportListToExcelById(Context context,String tablename,Cursor cursor,String[] titlename,int[] columnId) {  
       // mDb = db;  
            ...
            while (cur.getPosition() < cur.getCount()) {  
                for (int c = 0; c < numcols; c++) {  
                    if (r == 0) {  
                        ...
                        records[r + 1][c] = cur.getString(columnId[c]);  
                    } else {  
                        records[r + 1][c] = cur.getString(columnId[c]);  
                    }  
