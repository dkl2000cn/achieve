...
public class Fragment_TeamOpenTasks extends Fragment {
	...
	View oldview=null;
    View newview = null;
	com.easygoal.achieve.mListView lv_teamopentasks;
	 ...
	 @Override
		...
		//DatabaseHelper TdDB=new DatabaseHelper();
		 ...
		 final SwipeRefreshLayout swipeRefreshLayout=(SwipeRefreshLayout)v.findViewById(R.id.swipe_ly);
		  ...
		  lv_teamopentasks=(com.easygoal.achieve.mListView)v.findViewById(R.id.opentasks_lv);
		 ...
		 lv_teamopentasks.setOnDeleteListener(new mListView.OnDeleteListener() {
			 long oldClickTime=0;
			 @Override
			 public void onDelete(int index) {
				 //Log.d("mlistview delete", "del"+index);
				 long task_id = lv_teamopentasks.getAdapter().getItemId(index);
