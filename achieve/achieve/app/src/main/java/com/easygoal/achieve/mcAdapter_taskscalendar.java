...
public class mcAdapter_taskscalendar extends CursorAdapter {
	    ...
	    String Tags=" mcAdapter_taskscalendar";
	...
	public mcAdapter_taskscalendar(Context context, int lvitemlist,Cursor c) {
		super(context, c);
	...
	public void bindView(final View view, final Context context, Cursor cursor) {
        ...
        */        
    	...
    	String str_end=cursor.getString(cursor.getColumnIndex(TaskData.TdDB.TASK_DEADLINE));
    	//TimeData.convertTime_YYMMMDDHHSStoHHSS(str_d);
    	holder.taskdeadline.setText(TimeData.convertTime_YYMMMDDHHSStoHHSS(str_end));
