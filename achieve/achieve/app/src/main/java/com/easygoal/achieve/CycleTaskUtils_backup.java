...
public class CycleTaskUtils_backup {
    private Cursor c;
    public CycleTaskUtils_backup(Cursor c) {
        this.c=c;
    }

    public void checkTaskCycle(){
            ...
            do {
                ...
                if (TimeData.TimeGap_YYMMDDHHSS(curTime_str, deadline_str) < 0) {
                    ...
                    if (cycle_unit != null && cycle_unit.equals("单次")) {
                        ...
                        if (cycle_unit != null&& !cycle_unit.equals("单次")) {
                            try {
                                Log.d(Tags ,""+TaskData.cursor_opentasks.getPosition());
                                copy2NewTaskByCycleUnit();
    ...
    public void insertNewTaskRecordByCycleUnit(List<Map> value,String old_tsn,String new_tsn,int r_no){
        ...
        try{
            ...
            cv3.put(TaskData.TdDB.RECORD_TIME,TaskTool.getCurTime());
